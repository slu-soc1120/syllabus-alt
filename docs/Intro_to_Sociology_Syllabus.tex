...
Students will be required to complete two sociological experiences and write a short response paper summarizing your own experience. Additional details and a grading rubric are available on \textbf{\href{https://classroom.google.com}{Google Classroom}} under the `Classwork' tab. ``The Bus'' will be due on \textbf{Tuesday, October 1\textsuperscript{st}} and ``The Suitcase'' will be due on \textbf{Thursday, November 7\textsuperscript{th}}. Each reflection paper is worth 5\% of your final grade.
...
\begin{table}
\caption{\label{tab:unnamed-chunk-6}Course Grading Scale}

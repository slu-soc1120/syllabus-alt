...
Due dates for the Theory Post are as follows:
  ...
  1. Theory Isn't Dead 1 - **Sunday, August 30^th^**, with follow-ups due on **Tuesday, September 1^st^**
  2. Theory Isn't Dead 2 - **Sunday, September 20^th^**, with follow-ups due on **Tuesday, September 22^nd^**
  3. Theory Isn't Dead 3 - **Sunday, November 1^st^**, with follow-ups due on **Tuesday, November 3^rd^**
  4. Theory Isn't Dead 4 - **Sunday, November 22^nd^**, with follow-ups due on **Tuesday, November 24^th^**
...
Due dates for the Sociological Experiences are as follows:
  ...
  1. Sociological Experience 1 - High School - **Thursday, September 10^th^**
  2. Sociological Experience 2 - Socioeconomic Status - **Tuesday, September 29^th^**
  3. Sociological Experience 3 - Segregation - **Thursday, October 29^th^**
  4. Sociological Experience 4 - St. Louis - **Thursday, November 12^th^**
...
Quiz dates are as follows:
  ...
  1. Quiz 1 - **Monday, September 14^th^**
  2. Quiz 2 - **Monday, October 12^th^**
  3. Quiz 3 - **Monday, November 23^rd^**
      * If the flex day on Tuesday, November 24^th^ is needed for instruction, this quiz will be rescheduled.
...
All assignments must be submitted via Blackboard *as a Word (`.doc` or `.docx`) file or a `.pdf` file* unless otherwise noted in the assignment instructions. Feedback will be returned to students via comments embedded in each document.

...
As a reminder, all due dates are provisional due to the uncertainty around COVID-19 and how it will affect our semester. I will continually update you during class and via Blackboard about the status of each assignment's due dates as the semester progresses.
```

### Attendance and Participation

```{block, type = "rmdtip"}
Attendance and participation are worth 90 points, or **14.4%** of your final grade
```
...
```{block, type = "rmdtip"}
Theory posts are worth 80 points, or **12.8%** of your final grade
```
...
```{block, type = "rmdtip"}
Theory reflections are worth 80 points, or **12.8%** of your final grade
```
...
```{block, type = "rmdtip"}
QHQ Papers are worth 150 points, or **24%** of your final grade
```
...
```{block, type = "rmdtip"}
Quizzes are worth 150 points, or **24%** of your final grade
```
...
```{block, type = "rmdtip"}
The Final Project is worth 75 points, or **12%** of your final grade
```
...
```{r, echo=FALSE}
points <- data.frame(
  Assignment = c("Participation", "", "", "", "Theory Isn't Dead", "Sociological Experiences", "QHQs", "Quizzes", "Final Project"),
  Period = c("Part 1", "Part 2", "Part 3", "Part 4", "", "", "", "", ""),
  Points = c("20 pts", "30 pts", "30 pts", "10 pts", "20 pts", "20 pts", "75 pts", "50 pts", "75 pts"),
  Quantity = c("x1", "x1", "x1", "x1", "x4", "x4", "x2", "x3", "x1"),
  Total = c("20 pts", "30 pts", "30 pts", "10 pts", "80 pts", "80 pts", "150 pts", "150 pts", "75 pts"),
  Percent = c("14.4%", "", "", "", "12.8%", "12.8%", "24.0%", "24.0%", "12.0%"),
...
```{block, type = "rmdwarning"}
No chances will be given for revisions of poor grades. Incomplete grades will be given upon request only if you have a "C" average and have completed at least two-thirds of the possible points (412 points). You should note that incomplete grades must be rectified by the specified deadline or they convert to an "F". This policy reflects the [University's policy on incomplete coursework](https://catalog.slu.edu/academic-policies/academic-policies-procedures/incomplete-course/).
```

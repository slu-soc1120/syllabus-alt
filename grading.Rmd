...
```{block, type = "rmdtip"}
Attendance and participation are worth 95 points, or **16.1%** of your final grade
```
...
```{block, type = "rmdtip"}
Theory posts are worth 40 points, or **6.8%** of your final grade
```
...
```{block, type = "rmdtip"}
Theory reflections are worth 80 points, or **13.6%** of your final grade
```
...
```{block, type = "rmdtip"}
QHQ Papers are worth 150 points, or **25.4%** of your final grade
```
...
```{block, type = "rmdtip"}
Quizzes are worth 150 points, or **25.4%** of your final grade
```
...
```{block, type = "rmdtip"}
The Final Project is worth 75 points, or **12.7%** of your final grade
```
...
points <- data.frame(
  ...
  Points = c("20 pts", "30 pts", "30 pts", "15 pts", "20 pts", "20 pts", "75 pts", "50 pts", "75 pts"),
  Quantity = c("x1", "x1", "x1", "x1", "x2", "x4", "x2", "x3", "x1"),
  Total = c("20 pts", "30 pts", "30 pts", "15 pts", "40 pts", "80 pts", "150 pts", "150 pts", "75 pts"),
  Percent = c("16.1%", "", "", "", "6.8%", "13.6%", "25.4%", "25.4%", "12.7%"),
